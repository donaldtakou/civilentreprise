...
import RealisationsDynamiques from '../../components/RealisationsDynamiques';
...
export default function ProjetsClient({ realisations }: ProjetsClientProps) {
  ...
  useEffect(() => {
    const handleError = (event: ErrorEvent) => {
      ...
      setError(`Une erreur s'est produite: ${event.error?.message || 'Erreur inconnue'}`);
    };

    const handleUnhandledRejection = (event: PromiseRejectionEvent) => {
      console.error('Promesse rejetée:', event.reason);
      setError(`Erreur de chargement: ${event.reason?.message || 'Erreur inconnue'}`);
    };
  ...
  // Convertir les réalisations dynamiques au format des projets statiques
  const dynamicProjects = realisations.map(realisation => ({
    ...
    highlights: ['Projet réalisé', 'Qualité garantie', 'Satisfaction client'],
  }));
  ...
  const staticProjects = [
        // --- Nouveaux projets détaillés ---
        {
          ...
          images: [
            '/realisations/Duplex%20Babadjou/images/photo_1_2025-12-10_00-28-04.jpg',
            '/realisations/Duplex%20Babadjou/images/photo_2_2025-12-10_00-28-04.jpg',
            '/realisations/Duplex%20Babadjou/images/photo_3_2025-12-10_00-28-04.jpg',
            '/realisations/Duplex%20Babadjou/images/photo_4_2025-12-10_00-28-04.jpg',
            '/realisations/Duplex%20Babadjou/images/photo_5_2025-12-10_00-28-04.jpg',
            '/realisations/Duplex%20Babadjou/images/photo_6_2025-12-10_00-28-04.jpg',
          ],
          type: 'image' as const,
  ...
  //
        {
          ...
          location: 'Yaoundé',
          images: [
            '/realisations/Expertise%20Chantier%20SS-R%2B6/images/photo_7_2025-12-10_00-28-04.jpg',
            '/realisations/Expertise%20Chantier%20SS-R%2B6/images/photo_8_2025-12-10_00-28-04.jpg',
            '/realisations/Expertise%20Chantier%20SS-R%2B6/images/photo_9_2025-12-10_00-28-04.jpg',
            '/realisations/Expertise%20Chantier%20SS-R%2B6/images/photo_10_2025-12-10_00-28-04.jpg',
            '/realisations/Expertise%20Chantier%20SS-R%2B6/images/photo_11_2025-12-10_00-28-04.jpg',
          ],
          type: 'image' as const,
        ...
        },
        {
          ...
          location: 'Douala',
          images: [
            '/realisations/R%C3%A9novation%20Infrastructure%20Douala/images/photo_12_2025-12-10_00-28-04.jpg',
            '/realisations/R%C3%A9novation%20Infrastructure%20Douala/images/photo_13_2025-12-10_00-28-04.jpg',
          ],
          type: 'image' as const,
          description: "Projet de rénovation complète d'infrastructure à Douala : transformation d'un bâtiment existant en espace moderne et fonctionnel.",
          highlights: [
            "Rénovation complète",
            "Modernisation",
            "Économie d'énergie",
  ...
  // Combiner les projets : dynamiques en premier, puis statiques
    ...
    <main>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <ProjectModalManager projects={allProjects} />
        </div>
      </section>
      ...
      <RealisationsDynamiques realisations={realisations} />
